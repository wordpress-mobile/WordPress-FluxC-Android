    ...
    fun getOrdersForSite(
        ...
        if (!searchQuery.isNullOrEmpty()) {
            conditionClauseBuilder
                    ...
                    .or().contains(WCOrderModelTable.BILLING_COMPANY, searchQuery)
                    .or().contains(WCOrderModelTable.BILLING_ADDRESS1, searchQuery)
                    .or().contains(WCOrderModelTable.BILLING_ADDRESS2, searchQuery)
                    .or().contains(WCOrderModelTable.BILLING_CITY, searchQuery)
                    .or().contains(WCOrderModelTable.BILLING_STATE, searchQuery)
                    .or().contains(WCOrderModelTable.BILLING_POSTCODE, searchQuery)
                    .or().contains(WCOrderModelTable.BILLING_COUNTRY, searchQuery)
                    .or().contains(WCOrderModelTable.BILLING_EMAIL, searchQuery)
                    ...
                    .or().contains(WCOrderModelTable.SHIPPING_COMPANY, searchQuery)
                    .or().contains(WCOrderModelTable.SHIPPING_ADDRESS1, searchQuery)
                    .or().contains(WCOrderModelTable.SHIPPING_ADDRESS2, searchQuery)
                    .or().contains(WCOrderModelTable.SHIPPING_CITY, searchQuery)
                    .or().contains(WCOrderModelTable.SHIPPING_STATE, searchQuery)
                    .or().contains(WCOrderModelTable.SHIPPING_POSTCODE, searchQuery)
                    .or().contains(WCOrderModelTable.SHIPPING_COUNTRY, searchQuery)
                    .or().contains(WCOrderModelTable.REMOTE_ORDER_ID, searchQuery)
                    .endGroup()
        }
