...
public enum AccountAction implements IAction {
    ...
    @Action(payloadType = AccountRestClient.AccountRestPayload.class)
    ...
    @Action(payloadType = AccountStore.PostAccountSettingsPayload.class)
    ...
    @Action(payloadType = AccountStore.UpdateTokenPayload.class)
