...
class ReferrersStoreTest : BaseUnitTest() {
    ...
    private val liveResponse = MutableLiveData<ReferrersResponse>()
    ...
    fun `returns live data from db`() {
        ...
        val liveData = store.liveReferrers(site, DAYS, LimitMode.Top(ITEMS_TO_LOAD), DATE)

        var result: ReferrersModel? = null
        liveData.observeForever {
            result = it
        }
        liveResponse.value = REFERRERS_RESPONSE
