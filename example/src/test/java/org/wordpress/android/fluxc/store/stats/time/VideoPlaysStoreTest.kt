...
class VideoPlaysStoreTest : BaseUnitTest() {
    ...
    private val liveResponse = MutableLiveData<VideoPlaysResponse>()
    ...
    fun `returns live data from db`() {
        ...
        val liveData = store.liveVideoPlays(site, DAYS, LIMIT_MODE, DATE)

        var result: VideoPlaysModel? = null
        liveData.observeForever {
            result = it
        }
        liveResponse.value = VIDEO_PLAYS_RESPONSE
