...
import org.wordpress.android.fluxc.example.databinding.FragmentWooTaxesBinding
...
class WooTaxFragment : StoreSelectingFragment() {
    ...
    ): View = FragmentWooTaxesBinding.inflate(inflater, container, false).root

    @Suppress("TooGenericExceptionCaught")
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        with(FragmentWooTaxesBinding.bind(view)) {
            fetchTaxClass.setOnClickListener {
