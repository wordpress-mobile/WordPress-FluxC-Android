...
class BloggingPromptsRestClient @Inject constructor(
    ...
    suspend fun fetchPrompts(
        ...
        number: Int,
        from: Date
    ): BloggingPromptsPayload<BloggingPromptsResponse> {
        ...
        val response = wpComGsonRequestBuilder.syncGetRequest(
                ...
                url,
                params,
                BloggingPromptsResponse::class.java
        )
    ...
    suspend fun markPromptAsAnswered(
        site: SiteModel,
        promptId: Int
    ): BloggingPromptsPayload<BloggingPromptsMarkAsAnsweredResponse> {
        ...
        val response = wpComGsonRequestBuilder.syncGetRequest(
                ...
                url,
                params,
                BloggingPromptsMarkAsAnsweredResponse::class.java
        )
        return when (response) {
            is Success -> BloggingPromptsPayload(response.data)
            is Error -> BloggingPromptsPayload(response.error.toBloggingPromptsError())
    ...
    data class BloggingPromptsMarkAsAnsweredResponse(
        @SerializedName("success") val success: Boolean
    )

    data class BloggingPromptsResponse(
