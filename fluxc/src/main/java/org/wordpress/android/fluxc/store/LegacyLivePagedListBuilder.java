...
/**
 * Copy of a LivePagedListBuilder from Paging 2.1.2
 * PagedListBuilder from Paging 3 does not work well with our Lists, so we are using a previous version.
 *
 ...
 */
public final class LegacyLivePagedListBuilder<Key, Value> {
     ...
     */
    public LegacyLivePagedListBuilder(@NonNull DataSource.Factory<Key, Value> dataSourceFactory,
     ...
     */
    @NonNull
    public LegacyLivePagedListBuilder<Key, Value> setInitialLoadKey(@Nullable Key key) {
        mInitialLoadKey = key;
        return this;
    }
    ...
    @NonNull
    public LegacyLivePagedListBuilder<Key, Value> setBoundaryCallback(
    ...
    @SuppressWarnings("unused")
    @NonNull
    public LegacyLivePagedListBuilder<Key, Value> setFetchExecutor(
